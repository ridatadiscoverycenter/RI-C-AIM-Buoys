...
System_720 = GET(("https://api.riddc.brown.edu/telemetry/Buoy-720/System/lastweek"))
System_720 = fromJSON(rawToChar(System_720$content))


Hydrocat_720 = GET(("https://api.riddc.brown.edu/telemetry/Buoy-720/Hydrocat/lastweek"))
Hydrocat_720 = fromJSON(rawToChar(Hydrocat_720$content))


Suna_720 = GET(("https://api.riddc.brown.edu/telemetry/Buoy-720/SUNA/lastweek"))
Suna_720 = fromJSON(rawToChar(Suna_720$content))


ECO_720 = GET(("https://api.riddc.brown.edu/telemetry/Buoy-720/ECO/lastweek"))
ECO_720 = fromJSON(rawToChar(ECO_720$content))


MetData_720 = GET(("https://api.riddc.brown.edu/telemetry/Buoy-720/MetData/lastweek"))
MetData_720 = fromJSON(rawToChar(MetData_720$content))


Hydrocycle_720 = GET(("https://api.riddc.brown.edu/telemetry/Buoy-720/Hydrocycle/lastweek"))
Hydrocycle_720 = fromJSON(rawToChar(Hydrocycle_720$content))


PAR_720 = GET(("https://api.riddc.brown.edu/telemetry/Buoy-720/PAR/lastweek"))
...
System_620 = GET("https://api.riddc.brown.edu/telemetry/Buoy-620/System/lastweek")
System_620 = fromJSON(rawToChar(System_620$content))


Hydrocat_620 = GET(("https://api.riddc.brown.edu/telemetry/Buoy-620/Hydrocat/lastweek"))
Hydrocat_620 = fromJSON(rawToChar(Hydrocat_620$content))


Suna_620 = GET(("https://api.riddc.brown.edu/telemetry/Buoy-620/SUNA/lastweek"))
Suna_620 = fromJSON(rawToChar(Suna_620$content))


ECO_620 = GET(("https://api.riddc.brown.edu/telemetry/Buoy-620/ECO/lastweek"))
ECO_620 = fromJSON(rawToChar(ECO_620$content))


MetData_620 = GET(("https://api.riddc.brown.edu/telemetry/Buoy-620/MetData/lastweek"))
MetData_620 = fromJSON(rawToChar(MetData_620$content))


Hydrocycle_620 = GET(("https://api.riddc.brown.edu/telemetry/Buoy-620/Hydrocycle/lastweek"))
Hydrocycle_620 = fromJSON(rawToChar(Hydrocycle_620$content))


PAR_620 = GET(("https://api.riddc.brown.edu/telemetry/Buoy-620/PAR/lastweek"))
...
Solar_620_max <- max(System_620$SolarVoltage)
Solar_620_min <- min(System_620$SolarVoltage)
Battery_620_max <-max(System_620$Battery1Voltage)
Battery_620_min <-min(System_620$Battery1Voltage)
Hydrocat_620_ph_max <- max(Hydrocat_620$ph_despike)
Hydrocat_620_ph_min <-min(Hydrocat_620$ph_despike)
Hydrocat_620_oxy_max <- max(Hydrocat_620$Oxygen_despike)
Hydrocat_620_oxy_min <-min(Hydrocat_620$Oxygen_despike)
Hydrocat_620_salinity_max <- max(Hydrocat_620$salinity_despike)
Hydrocat_620_salinity_min <-min(Hydrocat_620$salinity_despike)
Hydrocat_620_temp_max <- max(Hydrocat_620$Temperature_despike)
Hydrocat_620_temp_min <-min(Hydrocat_620$Temperature_despike)
Hydrocat_620_turb_max <- max(Hydrocat_620$turbidity_despike)
Hydrocat_620_turb_min <- min(Hydrocat_620$turbidity_despike)
Hydrocat_620_fluor_max <- max(Hydrocat_620$fluorescence_despike)
Hydrocat_620_fluor_min <- min(Hydrocat_620$fluorescence_despike)
SUNA_620_nitrate_max <- max(Suna_620$Nitrate_despike)
SUNA_620_nitrate_min <- min(Suna_620$Nitrate_despike)
Hydrocycle_620_phosphate_max <- max(Hydrocycle_620$Phosphate_despike)
Hydrocycle_620_phosphate_min <- min(Hydrocycle_620$Phosphate_despike)
ECO_620_FDOM_max <- max(ECO_620$FDOM_despike)
ECO_620_FDOM_min <- min(ECO_620$FDOM_despike)

Solar_720_max <- max(System_720$SolarVoltage)
Solar_720_min <- min(System_720$SolarVoltage)
Battery_720_max <-max(System_720$Battery1Voltage)
Battery_720_min <-min(System_720$Battery1Voltage)
Hydrocat_720_ph_max <- max(Hydrocat_720$ph_despike)
Hydrocat_720_ph_min <-min(Hydrocat_720$ph_despike)
Hydrocat_720_oxy_max <- max(Hydrocat_720$Oxygen_despike)
Hydrocat_720_oxy_min <-min(Hydrocat_720$Oxygen_despike)
Hydrocat_720_salinity_max <- max(Hydrocat_720$salinity_despike)
Hydrocat_720_salinity_min <-min(Hydrocat_720$salinity_despike)
Hydrocat_720_temp_max <- max(Hydrocat_720$Temperature_despike)
Hydrocat_720_temp_min <-min(Hydrocat_720$Temperature_despike)
Hydrocat_720_turb_max <- max(Hydrocat_720$turbidity_despike)
Hydrocat_720_turb_min <- min(Hydrocat_720$turbidity_despike)
Hydrocat_720_fluor_max <- max(Hydrocat_720$fluorescence_despike)
Hydrocat_720_fluor_min <- min(Hydrocat_720$fluorescence_despike)
SUNA_720_nitrate_max <- max(Suna_720$Nitrate_despike)
SUNA_720_nitrate_min <- min(Suna_720$Nitrate_despike)
Hydrocycle_720_phosphate_max <- max(Hydrocycle_720$Phosphate_despike)
Hydrocycle_720_phosphate_min <- min(Hydrocycle_720$Phosphate_despike)
ECO_720_FDOM_max <- max(ECO_720$FDOM_despike)
ECO_720_FDOM_min <- min(ECO_720$FDOM_despike)
...
Solar_720 <- ggplot(System_720,aes(x=`TmStamp`, y=SolarVoltage)) + (scale_x_datetime(breaks = date_breaks("1 day"),
            labels = date_format("%m/%d"))) +  geom_line() +   ylab('Solar Voltage') + xlab('Date')+  theme_bw() +
...
labels = date_format("%m/%d"))) + geom_line() +  ylab('Battery Voltage') + xlab('Date')+  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
  theme(axis.text=element_text(size=12),
...
emails <- c( "kristofer_gomes@uri.edu","davies@uri.edu","timothy_divoll@brown.edu","maria_restrepo@brown.edu" )
