...
Hydrocycle_720_week$`TmStamp` <- parse_date_time(Hydrocycle_720_week$`TmStamp`, c("%y/%m/%d %H:%M:%S"))
...
Hydrocat_620_week = GET("https://api.riddc.brown.edu/telemetry/Buoy-620/Hydrocat/lastweek")
Hydrocat_620_week = fromJSON(rawToChar(Hydrocat_620_week$content))

Suna_620_week = GET("https://api.riddc.brown.edu/telemetry/Buoy-620/SUNA/lastweek")
Suna_620_week = fromJSON(rawToChar(Suna_620_week$content))

ECO_620_week = GET("https://api.riddc.brown.edu/telemetry/Buoy-620/ECO/lastweek")
ECO_620_week = fromJSON(rawToChar(ECO_620_week$content))

MetData_620_week = GET("https://api.riddc.brown.edu/telemetry/Buoy-620/MetData/lastweek")
MetData_620_week = fromJSON(rawToChar(MetData_620_week$content))

Hydrocycle_620_week = GET("https://api.riddc.brown.edu/telemetry/Buoy-620/Hydrocycle/lastweek")
Hydrocycle_620_week = fromJSON(rawToChar(Hydrocycle_620_week$content))

PAR_620_week = GET("https://api.riddc.brown.edu/telemetry/Buoy-620/PAR/lastweek")
PAR_620_week = fromJSON(rawToChar(PAR_620_week$content))



#Parse date/time values using Lubridate 

Hydrocat_620_week$TmStamp <- parse_date_time(Hydrocat_620_week$TmStamp, c("%y/%m/%d %H:%M:%S"))

ECO_620_week$`TmStamp` <- parse_date_time(ECO_620_week$`TmStamp`, c("%y/%m/%d %H:%M:%S"))
  
Suna_620_week$`TmStamp` <- parse_date_time(Suna_620_week$`TmStamp`, c("%y/%m/%d %H:%M:%S"))
  
MetData_620_week$`TmStamp` <- parse_date_time(MetData_620_week$`TmStamp`, c("%y/%m/%d %H:%M:%S"))
  
PAR_620_week$`TmStamp` <- parse_date_time(PAR_620_week$`TmStamp`, c("%y/%m/%d %H:%M:%S"))

Hydrocycle_620_week$`TmStamp` <- parse_date_time(Hydrocycle_620_week$`TmStamp`, c("%y/%m/%d %H:%M:%S"))

month_range <- (range(month(PAR_620_week$`TmStamp`))) #create month range of collected data to be used for filtering Narragansett Bay historical data by season
...
Hydrocycle_720_week$Phosphate_despike <- despike(Hydrocycle_720_week$'CAPO4',reference = c("median"), n=2, k=7, replace = c("reference"))



Hydrocat_620_week$Oxygen_despike <- despike(Hydrocat_620_week$`hydrocatDissOxygen`,reference = c("median"),n = 2,k = 7,replace = c("reference"))

Hydrocat_620_week$ph_despike <- despike(Hydrocat_620_week$`hydrocatPH`,reference = c("median"),n = 2,k = 7,replace = c("reference"))

Hydrocat_620_week$Temperature_despike <- despike(Hydrocat_620_week$`hydrocatTemperature`,reference = c("median"),n = 2,k = 7,replace = c("reference"))

Hydrocat_620_week$salinity_despike <- despike(Hydrocat_620_week$`hydrocatSalinity`,reference = c("median"),n = 2,k = 7,replace = c("reference"))

ECO_620_week$FDOM_despike <- despike(ECO_620_week$`ecoFDOM`,reference = c("median"), n=2, k=7, replace = c("reference"))

Suna_620_week$Nitrate_despike <- despike(Suna_620_week$`sunaNitrateMicroMol`,reference = c("median"), n=2, k=7, replace = c("reference"))

Hydrocycle_620_week$Phosphate_despike <- despike(Hydrocycle_620_week$'CAPO4',reference = c("median"), n=2, k=7, replace = c("reference"))
...
global_range_data <- read.csv('C:/Users/kgome/Documents/GitHub/RI-C-AIM-Buoys/data_qc_global_range_values.csv', header=TRUE, sep=",", na.strings=c(""))
...
Hydrocat_620_week <-mutate(Hydrocat_620_week,
                      Salinity_Global_Range_QC =ifelse(Hydrocat_620_week$`salinity_despike` > global_psu_max,
                                                             "2",ifelse( Hydrocat_620_week$`salinity_despike` < global_psu_min,"1","0"))) 
Hydrocat_620_week <-mutate(Hydrocat_620_week,
                     Temp_Global_Range_QC =ifelse(Hydrocat_620_week$`Temperature_despike` > global_temp_max,
                                                             "2",ifelse( Hydrocat_620_week$`Temperature_despike` < global_temp_min,"1","0")))
Hydrocat_620_week <-mutate(Hydrocat_620_week,
                     ph_Global_Range_QC =ifelse(Hydrocat_620_week$`ph_despike` > global_ph_max,
                                                             "2",ifelse( Hydrocat_620_week$`ph_despike` < global_ph_min,"1","0")))
Hydrocat_620_week <-mutate(Hydrocat_620_week,
                     oxy_Global_Range_QC =ifelse(Hydrocat_620_week$`Oxygen_despike` > global_oxy_max,
                                                             "2",ifelse( Hydrocat_620_week$`Oxygen_despike` < global_oxy_min,"1","0")))

ECO_620_week <- mutate(ECO_620_week,
                   FDOM_Global_Range_QC = ifelse(ECO_620_week$`FDOM_despike` > global_fluoro_max,
                                                 "2", ifelse(ECO_620_week$`FDOM_despike` < global_fluoro_min,"1","0")))

Suna_620_week <- mutate(Suna_620_week,
                    Nitrate_Global_Range_QC = ifelse(Suna_620_week$`Nitrate_despike` > global_nitrate_max,
                                                 "2", ifelse(Suna_620_week$`Nitrate_despike` < global_nitrate_min,"1","0")))
...
nb_hist_phys_data <- read.csv('C:/Users/kgome/Documents/GitHub/RI-C-AIM-Buoys/NB_PhysicalData_8.10.20201.csv', header=TRUE, sep=",", na.strings=c("","nd")) #Read in historical physical data from GSO LTS measurements
...
nb_hist_nutr_data <- read.csv('C:/Users/kgome/Documents/GitHub/RI-C-AIM-Buoys/nutrientdata_01.18.2021.csv', header=TRUE, sep=",", na.strings=c("","nd")) #Read in historical nutrient data from GSO LTS measurements
...
Hydrocycle_720_week <- mutate(Hydrocycle_720_week,
                    Phosphate_Seasonal_NB_Range_QC = ifelse(Hydrocycle_720_week$Phosphate_despike > max(seasonal_nb_DIP_range),
                                                 "2", ifelse(Hydrocycle_720_week$Phosphate_despike < min(seasonal_nb_DIP_range),"1","0")))




Hydrocat_620_week <-mutate(Hydrocat_620_week,
                      Salinity_Seasonal_NB_Range_QC =ifelse(Hydrocat_620_week$`salinity_despike` >  max(seasonal_nb_psu_range),
                                                             "2",ifelse( Hydrocat_620_week$`salinity_despike` < min(seasonal_nb_psu_range),"1","0"))) 
Hydrocat_620_week <-mutate(Hydrocat_620_week,
                     Temp_Seasonal_NB_Range_QC =ifelse(Hydrocat_620_week$`Temperature_despike` > max(seasonal_nb_surface_temp_range),
                                                             "2",ifelse( Hydrocat_620_week$`Temperature_despike` < min(seasonal_nb_surface_temp_range),"1","0")))

Suna_620_week <- mutate(Suna_620_week,
                    Nitrate_Global_Range_QC = ifelse(Suna_620_week$`Nitrate_despike` > max(seasonal_nb_nitrate_range),
                                                 "2", ifelse(Suna_620_week$`Nitrate_despike` < min(seasonal_nb_nitrate_range),"1","0")))
Hydrocycle_620_week <- mutate(Hydrocycle_620_week,
                    Phosphate_Seasonal_NB_Range_QC = ifelse(Hydrocycle_620_week$Phosphate_despike > max(seasonal_nb_DIP_range),
                                                 "2", ifelse(Hydrocycle_620_week$Phosphate_despike < min(seasonal_nb_DIP_range),"1","0")))
...
pdf(file="C:/Users/kgome/Documents/GitHub/RI-C-AIM-Buoys/Api_720_test_Plots_9_1_2021.pdf",width=16,height=12,useDingbats=FALSE)#open pdf graphical object to plot as pdf
...
ECO_720_plot <- ggplot(ECO_720_week,aes(x=`TmStamp`,y=ecoReadingRaw, color=FDOM_Global_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
...
Hydrocycle_720_plot <- ggplot(Hydrocycle_720_week,aes(x=`TmStamp`,y=Phosphate_despike, color=Phosphate_Seasonal_NB_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
...
pdf(file="C:/Users/kgome/Documents/GitHub/RI-C-AIM-Buoys/Api_620_test_Plots_9_1_2021.pdf",width=16,height=12,useDingbats=FALSE)#open pdf graphical object to plot as pdf

Hydro_Salinity_620 <- ggplot(Hydrocat_620_week,aes(x=`TmStamp`, y=salinity_despike, color=Salinity_Global_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
        labels = date_format("%m/%d")))  +  geom_line() + scale_color_manual(breaks = c("0", "1", "2"),values=c("#009900", "#00CCCC", "#CC0000")) + ylab('Salinity (psu)') +         xlab('Date')+  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
...
Hydro_Temp_620 <- ggplot(Hydrocat_620_week,aes(x=`TmStamp`, y=Temperature_despike, color=Temp_Global_Range_QC )) + (scale_x_datetime(breaks = date_breaks("1 day"),
        labels = date_format("%m/%d")))  +  geom_line() + scale_color_manual(breaks = c("0", "1", "2"),values=c("#009900", "#00CCCC", "#CC0000")) + ylab('Temperature (Celcius)') +   xlab('Date')+  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
...
Hydro_pH_620 <- ggplot(Hydrocat_620_week,aes(x=`TmStamp`, y=ph_despike, color=ph_Global_Range_QC )) + (scale_x_datetime(breaks = date_breaks("1 day"),
        labels = date_format("%m/%d")))  +  geom_line() + scale_color_manual(breaks = c("0", "1", "2"),values=c("#009900", "#00CCCC", "#CC0000")) + ylab('pH') + xlab('Date')+       theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
...
Hydro_oxy_620 <- ggplot(Hydrocat_620_week,aes(x=`TmStamp`, y=Oxygen_despike, color=oxy_Global_Range_QC )) + (scale_x_datetime(breaks = date_breaks("1 day"),
        labels = date_format("%m/%d")))  +  geom_line() + scale_color_manual(breaks = c("0", "1", "2"),values=c("#009900", "#00CCCC", "#CC0000")) + ylab('Dissolved Oxygen (mg/L)')   + xlab('Date')+  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
...
Wind_620_Plot <- ggplot(MetData_620_week,aes(x=`TmStamp`, y=avgWindSpeed)) + (scale_x_datetime(breaks = date_breaks("1 day"),
  labels = date_format("%m/%d")))  +  geom_line() + ylab('Average Wind Speed (m/s)') + xlab('Date')+  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
...
Temperature_620_Plot <- ggplot(MetData_620_week,aes(x=`TmStamp`, y=maximetTemperature)) + (scale_x_datetime(breaks = date_breaks("1 day"),
  labels = date_format("%m/%d")))  +  geom_line() + ylab('Temperature (Celcius)') + xlab('Date')+  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
...
Humidity_620_Plot <- ggplot(MetData_620_week,aes(x=`TmStamp`, y=maximetHumidity)) + (scale_x_datetime(breaks = date_breaks("1 day"),
  labels = date_format("%m/%d")))  +  geom_line() + ylab('Humidity (%)') + xlab('Date')+  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
...
Pressure_620_Plot <- ggplot(MetData_620_week,aes(x=`TmStamp`, y=maximetPressure)) + (scale_x_datetime(breaks = date_breaks("1 day"),
  labels = date_format("%m/%d")))  +  geom_line() + ylab('Pressure (db)') + xlab('Date')+  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
...
Precipitation_620_Plot <- ggplot(MetData_620_week,aes(x=`TmStamp`, y=maximetPrecipitation)) + (scale_x_datetime(breaks = date_breaks("1 day"),
  labels = date_format("%m/%d")))  +  geom_line() + ylab('Precipitation (mm/Hr)') + xlab('Date')+  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
...
Suna_620_plot <- ggplot(Suna_620_week,aes(x=`TmStamp`, y=Nitrate_despike, color=Nitrate_Global_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
  labels = date_format("%m/%d")))  +  geom_line() + scale_color_manual(breaks = c("0", "1", "2"),values=c("#009900", "#00CCCC", "#CC0000")) + ylab('Nitrate (umol)') + xlab('Date')+  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
...
ECO_620_plot <- ggplot(ECO_620_week,aes(x=`TmStamp`,y=ecoReadingRaw, color=FDOM_Global_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
  labels = date_format("%m/%d")))  +  geom_line() + scale_color_manual(breaks = c("0", "1", "2"),values=c("#009900", "#00CCCC", "#CC0000")) + ylab('FDOM (ppb)') + xlab('Date') +  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
...
ECO_620_plot <- ggplot(ECO_620_week,aes(x=`TmStamp`,y=FDOM_despike, color=FDOM_Global_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
  labels = date_format("%m/%d")))  +  geom_line() + scale_color_manual(breaks = c("0", "1", "2"),values=c("#009900", "#00CCCC", "#CC0000")) + ylab('FDOM (ppb)') + xlab('Date') +  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
...
Hydrocycle_620_plot <- ggplot(Hydrocycle_620_week,aes(x=`TmStamp`,y=Phosphate_despike, color=Phosphate_Seasonal_NB_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
  labels = date_format("%m/%d")))  +  geom_line() + scale_color_manual(breaks = c("0", "1", "2"),values=c("#009900", "#00CCCC", "#CC0000")) + ylab('Phosphate (uM)') + xlab('Date') +  theme_bw() +
  theme(panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank(),
        axis.text.x=element_text(angle=0)) +
...
```{r}
ECO_620_raw_plot <- ggplot(ECO_620_week,aes(x=`TmStamp`,y=ecoReadingRaw, color=FDOM_Global_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
...
ECO_620_fdom_plot <- ggplot(ECO_620_week,aes(x=`TmStamp`,y=FDOM_despike, color=FDOM_Global_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
...
ECO_620_channel_plot <- ggplot(ECO_620_week,aes(x=`TmStamp`,y=ecoChannel, color=FDOM_Global_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
...
ECO_620_wavelength_plot <- ggplot(ECO_620_week,aes(x=`TmStamp`,y=ecoWavelength, color=FDOM_Global_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
...
ECO_720_raw_plot <- ggplot(ECO_720_week,aes(x=`TmStamp`,y=ecoReadingRaw, color=FDOM_Global_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
...
ECO_720_fdom_plot <- ggplot(ECO_720_week,aes(x=`TmStamp`,y=FDOM_despike, color=FDOM_Global_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
...
ECO_720_channel_plot <- ggplot(ECO_720_week,aes(x=`TmStamp`,y=ecoChannel, color=FDOM_Global_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
...
ECO_720_wavelength_plot <- ggplot(ECO_720_week,aes(x=`TmStamp`,y=ecoWavelength, color=FDOM_Global_Range_QC)) + (scale_x_datetime(breaks = date_breaks("1 day"),
