...
#GPS_data$`TmStamp` <- parse_date_time(GPS_data$`TmStamp`, c("%y/%m/%d %H:%M:%S"))
  
#Castlehill_hydro_data$TmStamp <- parse_date_time(Castlehill_hydro_data$TmStamp, c("%y/%m/%d %H:%M:%S"))
```
